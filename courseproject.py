...
lb1 = Label(root, bg = "#00283d", fg = "#84ceeb", text = "English", font = "calibri")    #creating label for displaying text
lb1.place(x = 400, y = 270)

lb2 = Label(root, bg = "#00283d", fg = "#84ceeb", text = "Language", font = "calibri")   #creating label for displaying text
...
menu = StringVar()                                                                       #creaing menu(drop-down) for different languages
menu.set("Select")
